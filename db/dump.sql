...
SELECT pg_catalog.setval('feature_type_id', 5, true);
...
SELECT pg_catalog.setval('unit_id', 3, true);
...
2	Bedrooms	\N
3	Bathrooms	\N
4	Distance from closest city	3
\.
...
1	Mikhail	Cherviakov	htonus@gmail.com	htonus	9ac20922b054316be23842a5bca7d69f29f69d77
\.
